      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gray-50 rounded-2xl p-8">
          <div className="space-y-6">
            ...
            <button className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition-all duration-200 transform hover:scale-105 shadow-lg">
              Generate Logo Ideas
            </button>
          </div>
        </div>
