...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-20 bg-gradient-to-br from-slate-900 to-blue-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqData.map((item, index) => (
            <div
              key={index}
              className="bg-white/10 backdrop-blur-sm border border-blue-400/20 rounded-xl overflow-hidden transition-all duration-300 hover:bg-white/15"
            >
              {/* Question */}
              <button
              ...
              >
                ...
                <span className="flex-shrink-0 w-8 h-8 bg-blue-500/20 rounded-full flex items-center justify-center text-blue-300 font-mono text-sm transition-all duration-300">
                  {openIndex === index ? 'v' : '>'}
                </span>
              </button>
